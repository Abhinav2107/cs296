...
namespace cs296
{
  ...
  /**
   * The settings_t structure contains the simulation settings.\n
   * Some of these settings can be controlled via the GUI like iterations, sub_stepping, etc.\n
   * The features of Pause and Single Stepping are also set in this structure.\n
   * Mostly the structure contains int32 variables  (except 1 float32 & 1 b2Vec2).
   * 
   */
  ...
  //!The sim_t structure contains references to the elements in the simulation.
  struct sim_t
  {
    const char *name;
  ...
  //!Structure contact_point_t stores details about the contact point between two fixtures.
  /**
   * It stores the two fixtures, the position, the normal and the state.
   * 
   */
  ...
  /**
   * This class has the functions and variables to handle all the simulation.\n
   * This class keeps track of all the points, steps, joints, etc. in the simulation.
   * Also, this class contains methods to handle user interaction in the form of keyboard and mouse input.
   * 
   */
